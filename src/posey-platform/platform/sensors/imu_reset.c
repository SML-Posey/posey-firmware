...
// static const struct gpio_dt_spec gpio_imu_reset = DT_GPIO_LABEL(DT_ALIAS(gpioimureset0), gpios);
static const struct gpio_dt_spec gpio_imu_reset = GPIO_DT_SPEC_GET(DT_PATH(zephyr_user), imureset_gpios);
