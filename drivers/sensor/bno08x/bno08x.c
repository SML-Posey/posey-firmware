...
static inline void bno08x_accel_convert(
...
static inline void bno08x_gyro_convert(
    struct sensor_value *val,
    double dval)
{
	sensor_value_from_double(val, dval);
...
static inline void bno08x_magn_convert(
    struct sensor_value *val,
    double dval)
{
	sensor_value_from_double(val, dval);
